...
export class CatalogService {
  ...
  createEvent(data: Partial<EventItem>): EventItem {
    const venue = this.venues.find((v) => v.id === data.venue_id) || this.venues[0];
